...
pnpm add -D <package-name>    # Instala dependência de desenvolvimento com pnpm` },
            ...
            },
            {
                ...
                content: [
                  ...
                  { type: 'paragraph', text: 'O componente mais fundamental para construir uma UI. É um contentor que suporta layout com flexbox, estilos e manuseamento de toques. Uma View mapeia diretamente para as vistas nativas subjacentes, seja `UIView` no iOS, `android.view.View` no Android ou `<div>` na web. É ideal para aninhar outros componentes.' },
...
const styles = StyleSheet.create({
  ...
  box3: { width: 50, height: 50, backgroundColor: 'steelblue' },
                  ...
                  { type: 'paragraph', text: 'Um componente para exibir texto. `Text` suporta aninhamento, estilos e manuseamento de toques. Qualquer texto que queira exibir na sua aplicação deve estar dentro de um componente `Text`.' },
                  { type: 'code', language: 'jsx', code: `
import React from 'react';
...
const styles = StyleSheet.create({
  ...
  innerText: {
    ...
    color: 'red',
                  ...
                  { type: 'paragraph', text: 'Um componente para exibir imagens. Pode carregar imagens do pacote da sua aplicação (imagens locais) ou da rede.' },
                  { type: 'code', language: 'jsx', code: `
import React from 'react';
...
const styles = StyleSheet.create({
  ...
  logo: {
    ...
    marginBottom: 10,
                  ...
                  { type: 'paragraph', text: 'Um componente de entrada de texto fundamental que permite ao utilizador introduzir texto. Tem propriedades como `onChangeText` para manusear as alterações de texto e `onSubmitEditing` para quando o texto é submetido.' },
                  { type: 'code', language: 'jsx', code: `
...
const styles = StyleSheet.create({
  ...
  input: {
    ...
    paddingHorizontal: 10,
                  ...
                  { type: 'paragraph', text: 'Um contentor genérico com capacidade de deslocamento que pode albergar múltiplos componentes e vistas. É útil para apresentar uma pequena quantidade de elementos de comprimento variável. Para listas longas, é melhor usar `FlatList` pelo seu desempenho.' },
                  { type: 'code', language: 'jsx', code: `
import React from 'react';
...
const styles = StyleSheet.create({
  ...
  text: { fontSize: 32 },
                  ...
                  { type: 'paragraph', text: 'O componente `Pressable` é um contentor que deteta várias fases de interações de pressão em qualquer um dos seus elementos descendentes. É uma abstração mais potente e flexível do que `Button` ou `TouchableOpacity`.' },
                  { type: 'code', language: 'jsx', code: `
import React, { useState } from 'react';
...
const styles = StyleSheet.create({
  ...
  text: { fontSize: 16 }
                  ...
                  { type: 'paragraph', text: 'Um componente de botão básico que é renderizado de forma nativa em cada plataforma. É simples de usar mas menos personalizável do que `Pressable` ou `TouchableOpacity`.' },
                  { type: 'code', language: 'jsx', code: `
import React from 'react';
...
const styles = StyleSheet.create({
  container: {
    ...
    padding: 10
                  ...
                  { type: 'paragraph', text: 'Um componente booleano de ligar/desligar. É um controlo que pode estar num de dois estados: ativado ou desativado.' },
                  { type: 'code', language: 'jsx', code: `
import React, { useState } from 'react';
...
const styles = StyleSheet.create({
  container: {
    ...
    justifyContent: "center"
                  ...
                  { type: 'paragraph', text: 'Um componente de alto desempenho para renderizar listas. `FlatList` é ideal para listas longas e dinâmicas, pois apenas renderiza os itens que estão atualmente no ecrã, poupando memória и tempo de processamento.' },
                  { type: 'code', language: 'jsx', code: `
import React from 'react';
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24 },
                  ...
                  { type: 'paragraph', text: 'Semelhante a `FlatList`, mas para renderizar listas seccionadas. É útil quando tem dados agrupados e quer mostrar cabeçalhos para cada secção.' },
                  { type: 'code', language: 'jsx', code: `
import React from 'react';
