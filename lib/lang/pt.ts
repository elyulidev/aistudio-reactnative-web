...
export default () => <Text>About Screen</Text>;
            ...
            },
            {
                ...
                content: [
                  { type: 'heading', text: 'Palestra 2: Configuração do Ambiente de Desenvolvimento (2h)' },
                  { type: 'list', items: [
                      'Instalação do Node.js e gerenciamento de pacotes com npm/Yarn.',
                      'Configuração do seu IDE: VS Code ou WebStorm (uma ferramenta poderosa para JavaScript e TypeScript).',
                      'Criação de um projeto React Native com **npx create-expo-app**.',
                      'Execução do seu primeiro aplicativo no Expo Go (em dispositivos físicos Android/iOS).',
                      'Configuração opcional de simuladores (Android Studio para Android, Xcode para iOS) para uma experiência de desenvolvimento mais integrada.',
                  ]},
                ]
            },
            {
