...
`},
        ...
        { type: 'paragraph', text: 'Luego, añade el plugin a tu `babel.config.js`:' },
        { type: 'code', language: 'javascript', code: `
// babel.config.js
...
`},
        { type: 'callout', alertType: 'warning', text: 'Después de añadir el plugin de Babel, es crucial reiniciar el servidor de desarrollo con `npx expo start --clear`.' },
        ...
        { type: 'subtitle', text: '4. Práctica: Animando la Aparición de un Componente' },
        { type: 'paragraph', text: 'Vamos a crear un efecto de "fade in" y deslizamiento hacia arriba para un componente cuando aparece.' },
...
`},
        { type: 'callout', alertType: 'tip', text: 'La clave es usar los componentes `Animated` (ej. `Animated.View`) para que Reanimated pueda aplicar eficientemente los estilos calculados en el hilo de la UI.'}
    ]
};
