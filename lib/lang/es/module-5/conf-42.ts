...
export const conference42: CurriculumTopic = {
    ...
    content: [
        ...
        { type: 'paragraph', text: 'Continuamos con nuestra aplicación de inmobiliaria. En esta parte, construiremos el componente `PropertyCard` reutilizable, la pantalla de detalles de la propiedad, y el formulario para añadir nuevas propiedades, incluyendo la selección de imágenes desde el dispositivo.' },
        { type: 'divider' },

        { type: 'subtitle', text: 'Paso 5: Crear el Componente `PropertyCard`' },
        { type: 'paragraph', text: 'Crea un archivo `components/PropertyCard.tsx`. Este componente mostrará un resumen de una propiedad y será el elemento que se renderizará en nuestra `FlatList`.' },
...
`},
        { type: 'paragraph', text: 'No olvides importar y usar este componente en el `renderItem` de la `FlatList` en `app/index.tsx`.' },
        { type: 'divider' },

        { type: 'subtitle', text: 'Paso 6: Crear la Pantalla de Detalles (`app/property/[id].tsx`)' },
        { type: 'paragraph', text: 'Esta pantalla mostrará toda la información de una propiedad específica.' },
        { type: 'code', language: 'tsx', code: `
// app/property/[id].tsx
...
`},
        ...
        { type: 'subtitle', text: 'Paso 7: Crear el Formulario de Añadir/Editar Propiedad' },
        { type: 'paragraph', text: 'Crea la pantalla `app/add-property.tsx`. Este formulario servirá tanto para crear nuevas propiedades como para editar las existentes.' },
        { type: 'paragraph', text: 'Instala las dependencias necesarias para la selección de imágenes:' },
        { type: 'code', language: 'bash', code: 'npx expo install expo-image-picker expo-file-system' },
        { type: 'code', language: 'tsx', code: `
...
`},
        { type: 'paragraph', text: '¡Felicidades! Has completado una aplicación full-stack local, manejando datos, imágenes y navegación compleja.' }
    ]
};
