...
export const conference44: CurriculumTopic = {
    ...
    content: [
        ...
        { type: 'subtitle', text: '2. Práctica: Creando un Componente `<Button>` Reusable' },
        { type: 'paragraph', text: 'Vamos a construir un componente de botón que pueda tener diferentes variantes (primario, secundario) y tamaños, y que sea completamente reutilizable en nuestra aplicación.' },
...
`},
        { type: 'paragraph', text: 'Ahora, en cualquier parte de tu app, puedes usarlo así:' },
...
`},
        ...
        { type: 'subtitle', text: '3. Patrón de Composición: Creando un `<Card>` Genérico' },
        { type: 'paragraph', text: 'Un componente de tarjeta es un contenedor común. En lugar de forzar una estructura de título/contenido, lo haremos flexible usando `children`.' },
...
export default Card;
`},
        { type: 'paragraph', text: 'Este `Card` ahora puede contener cualquier cosa, dándole una flexibilidad increíble:' },
        { type: 'code', language: 'jsx', code: `
// Uso simple
<Card>
...
`},
        { type: 'callout', alertType: 'info', text: 'Este patrón, donde un componente se usa para "envolver" a otros, se conoce como composición y es uno de los conceptos más fundamentales y poderosos de React.' },
    ]
};
