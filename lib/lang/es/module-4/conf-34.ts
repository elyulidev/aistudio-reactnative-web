...
export const conference34: CurriculumTopic = {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'Muchas aplicaciones necesitan que los usuarios suban imágenes, ya sea para un perfil, una publicación o un producto. En esta conferencia, aprenderemos a usar `expo-image-picker` para acceder a la cámara y la galería del dispositivo, y `expo-file-system` para gestionar estos archivos de forma persistente.' },
      { type: 'divider' },

      { type: 'subtitle', text: '1. Instalación y Permisos' },
      { type: 'paragraph', text: 'Primero, necesitamos instalar la librería para seleccionar imágenes:' },
      { type: 'code', language: 'bash', code: `npx expo install expo-image-picker` },
      { type: 'paragraph', text: 'Para acceder a la cámara o a la galería, la aplicación debe solicitar permiso al usuario. `expo-image-picker` nos proporciona funciones para gestionar esto. No es necesario añadir nada al `app.json` para la configuración básica en Expo Go, pero para builds de producción sí se requiere.' },
      { type: 'divider' },
      
      { type: 'subtitle', text: '2. Captura de Imágenes desde la Galería' },
      { type: 'paragraph', text: 'Vamos a crear una función que solicite permiso para acceder a la galería y, si se concede, abra el selector de imágenes.' },
...
`},
      ...
      { type: 'subtitle', text: '3. Almacenamiento Persistente con `expo-file-system`' },
      { type: 'paragraph', text: 'Como la URI de `expo-image-picker` es temporal, si queremos que la imagen persista entre sesiones, debemos copiarla a un directorio permanente de nuestra aplicación. Aquí es donde entra en juego `expo-file-system`.' },
      { type: 'paragraph', text: 'Instalamos la librería:' },
      { type: 'code', language: 'bash', code: 'npx expo install expo-file-system' },
      { type: 'paragraph', text: 'Luego, podemos crear una función para guardar la imagen:' },
...
`},
      ...
      { type: 'heading', text: '¡Pon a prueba tus conocimientos!' },
        { 
          ...
          questions: [
            {
              "question": "¿Qué función de `expo-image-picker` se utiliza para abrir la galería de fotos del dispositivo?",
              "options": ["`launchCameraAsync`", "`getMediaLibraryPermissionsAsync`", "`launchImageLibraryAsync`", "`getAlbumAsync`"],
              "correctAnswer": 2
            },
            {
              "question": "La URI de una imagen devuelta por `expo-image-picker` es...",
              "options": ["Permanente y segura para almacenar en una base de datos.", "Una URL pública accesible desde cualquier lugar.", "Temporal y podría ser eliminada por el sistema operativo.", "Una cadena en base64."],
              "correctAnswer": 2
            },
            {
              "question": "¿Para qué se utiliza `expo-file-system` en el contexto de la selección de imágenes?",
              "options": ["Para comprimir la imagen seleccionada.", "Para aplicar filtros a la imagen.", "Para copiar la imagen desde su ubicación temporal a un directorio permanente de la aplicación.", "Para subir la imagen a un servidor en la nube."],
              "correctAnswer": 2
            },
            {
              "question": "`FileSystem.documentDirectory` apunta a...",
              "options": ["La carpeta de descargas del dispositivo.", "Un directorio público en la tarjeta SD.", "Un directorio privado y persistente dentro del espacio de tu aplicación.", "La caché de la aplicación, que se borra regularmente."],
              "correctAnswer": 2
            }
          ]
        }
