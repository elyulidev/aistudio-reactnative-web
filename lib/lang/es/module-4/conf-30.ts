...
`},
      ...
      { type: 'subtitle', text: '4. Manejando Estados Vacíos con `ListEmptyComponent`' },
      { type: 'paragraph', text: '¿Qué sucede si tu array de `data` está vacío? Por defecto, `FlatList` no mostrará nada. Para una mejor experiencia de usuario, podemos proporcionar un componente para que se renderice en este caso usando la prop `ListEmptyComponent`.' },
...
`},
      ...
      { type: 'heading', text: '¡Pon a prueba tus conocimientos!' },
        { 
          ...
          questions: [
            {
              "question": "¿Cuál es el principal problema de rendimiento al usar `ScrollView` con un `.map()` para una lista muy larga?",
              "options": ["Renderiza todos los elementos de la lista a la vez, consumiendo mucha memoria.", "No permite el desplazamiento horizontal.", "Es difícil de estilizar.", "No puede manejar datos asíncronos."],
              "correctAnswer": 0
            },
            {
              "question": "La técnica que `FlatList` utiliza para renderizar solo los elementos visibles en la pantalla se llama:",
              "options": ["Lazy Loading", "Virtualización", "Memoización", "Renderizado Condicional"],
              "correctAnswer": 1
            },
            {
              "question": "¿Qué prop de `FlatList` es responsable de definir cómo se debe renderizar cada elemento de la lista?",
              "options": ["`data`", "`component`", "`keyExtractor`", "`renderItem`"],
              "correctAnswer": 3
            },
            {
              "question": "Si tu array de datos está vacío, ¿qué prop de `FlatList` puedes usar para mostrar un mensaje al usuario?",
              "options": ["`EmptyComponent`", "`ListEmptyComponent`", "`renderEmpty`", "`fallback`"],
              "correctAnswer": 1
            }
          ]
        }
