...
export const conference36: CurriculumTopic = {
    ...
    content: [
      ...
      { type: 'paragraph', text: '**2. Esquema de la Base de Datos para Favoritos:**' },
      { type: 'list', items: [
      ...
      { type: 'paragraph', text: '**5. Pantalla de Detalles (`app/recipe/[id].tsx`):**' },
      { type: 'list', items: [
