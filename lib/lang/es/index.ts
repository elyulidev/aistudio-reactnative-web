...
const evaluations: CurriculumTopic = {
    ...
    content: [
        ...
        { type: 'paragraph', text: 'Aquí puedes encontrar los informes de evaluación del curso. Por favor, descarga la versión correspondiente a tu idioma.' },
        {
...
const bibliography: CurriculumTopic = {
    ...
    content: [
        ...
        { type: 'paragraph', text: 'Aquí encontrarás una colección de libros y documentación oficial recomendada para profundizar en los temas del bootcamp.' },
        {
            ...
            bibliographyCards: [
                {
                    ...
                    description: 'Un libro completo que cubre los fundamentos y patrones avanzados para construir aplicaciones de alta calidad con React Native.',
                    buttonText: 'Descargar PDF',
                    url: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf'
                },
                {
                    ...
                    description: 'Aprende a diseñar y gestionar bases de datos relacionales locales, un recurso esencial para la persistencia de datos offline.',
                    buttonText: 'Descargar PDF',
                    url: 'https://www.adobe.com/support/products/enterprise/knowledgecenter/media/c4611_sample_explain.pdf'
                },
                {
                    ...
                    description: 'La fuente de verdad para todo lo relacionado con React Native. Imprescindible para consultar APIs de componentes y guías.',
                ...
                },
                {
                    ...
                    description: 'Explora el ecosistema de Expo, desde el enrutamiento hasta el acceso a APIs nativas y el proceso de build. Tu mejor amigo en el desarrollo.',
                    buttonText: 'Visitar Sitio',
