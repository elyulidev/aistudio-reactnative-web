...
export const conference4: CurriculumTopic = {
    ...
    content: [
        ...
        { type: 'paragraph', text: 'Muestra un indicador de carga circular. Es extremadamente útil para dar feedback al usuario de que un proceso está en curso, como la carga de datos desde una red. Puedes personalizar su tamaño y color.' },
...
const styles = StyleSheet.create({
  container: {
    ...
    padding: 10,
        ...
        { type: 'paragraph', text: 'Lanza un cuadro de diálogo de alerta nativo con un título, un mensaje y botones. La API `Alert` es multiplataforma y te permite crear alertas simples o con múltiples botones para acciones como confirmar o cancelar.' },
        { type: 'code', language: 'jsx', code: `
import React from 'react';
...
const styles = StyleSheet.create({
  container: {
    ...
    padding: 10,
        ...
        { type: 'paragraph', text: 'La librería `Animated` está diseñada para crear animaciones fluidas e interactivas. Permite controlar valores a lo largo del tiempo y aplicarlos a estilos de componentes. Es una API potente para crear efectos visuales complejos como desvanecimientos, deslizamientos y transformaciones.' },
        { type: 'code', language: 'jsx', code: `
...
const styles = StyleSheet.create({
    ...
    text: { fontSize: 24, textAlign: 'center' }
        ...
        { type: 'paragraph', text: 'Proporciona una API para obtener las dimensiones (ancho y alto) de la pantalla o la ventana del dispositivo. Es útil para crear diseños responsivos que se adaptan a diferentes tamaños de pantalla, aunque para cambios dinámicos (como la rotación) se recomiendan otros enfoques como los hooks.' },
        { type: 'code', language: 'jsx', code: `
import React from 'react';
...
const styles = StyleSheet.create({ container: { padding: 10 } });`},
        ...
        { type: 'paragraph', text: 'Es un componente diseñado para resolver un problema común: el teclado virtual cubriendo los campos de texto. Este componente ajusta automáticamente su altura, posición o relleno inferior en respuesta a la aparición del teclado.' },
        { type: 'code', language: 'jsx', code: `
import React from 'react';
...
const styles = StyleSheet.create({
  ...
  input: { height: 40, borderColor: 'gray', borderWidth: 1, padding: 10 },
        ...
        { type: 'paragraph', text: 'Proporciona una interfaz para interactuar con enlaces de aplicaciones tanto entrantes como salientes. Puede usarse para abrir URLs en un navegador web, enviar correos electrónicos, abrir mapas o realizar una llamada telefónica.' },
        { type: 'code', language: 'jsx', code: `
import React from 'react';
...
export default function LinkingExample() {
    ...
    return <Button title="Abrir Documentación" onPress={openURL} />;
        ...
        { type: 'paragraph', text: 'El componente Modal es una forma de presentar contenido por encima de una vista principal. Es ideal para mostrar alertas personalizadas, selectores o cualquier contenido que deba captar la atención del usuario temporalmente.' },
        { type: 'code', language: 'jsx', code: `
...
const styles = StyleSheet.create({
    ...
    modalView: { margin: 20, backgroundColor: 'white', borderRadius: 20, padding: 35, alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 4, elevation: 5 },
        ...
        { type: 'paragraph', text: '`PixelRatio` te da acceso a la densidad de píxeles del dispositivo. Es útil para ajustar el tamaño de imágenes y otros elementos para que se vean nítidos en pantallas de alta resolución (como las pantallas Retina).' },
        { type: 'code', language: 'jsx', code: `
import React from 'react';
...
const styles = StyleSheet.create({ container: { padding: 10 } });`},
        ...
        { type: 'paragraph', text: 'Este componente se usa dentro de un `ScrollView` o `FlatList` para añadir la funcionalidad de "deslizar para refrescar" (pull-to-refresh). Es un patrón de UX muy común para recargar datos.' },
        { type: 'code', language: 'jsx', code: `
...
const styles = StyleSheet.create({ container: { flex: 1, justifyContent: 'center', paddingTop: Platform.OS === 'android' ? StatusBar.currentHeight : 0 } });`},
        ...
        { 
          ...
          questions: [
            { 
              "question": "¿Qué componente usarías para mostrar un indicador de carga circular mientras se obtienen datos de una API?", 
              "options": ["StatusBar", "ActivityIndicator", "RefreshControl", "Modal"], 
              "correctAnswer": 1 
            },
            { 
              "question": "Para implementar la funcionalidad 'deslizar para refrescar' en una lista, ¿qué componente deberías usar dentro de un `ScrollView`?", 
              "options": ["Animated", "Linking", "RefreshControl", "Alert"], 
              "correctAnswer": 2 
            },
            { 
              "question": "¿Qué API te permite abrir un enlace web o una aplicación de correo electrónico desde tu app?", 
              "options": ["Dimensions", "PixelRatio", "Linking", "Alert"], 
              "correctAnswer": 2
            },
            { 
              "question": "Si necesitas que un campo de texto no sea cubierto por el teclado cuando el usuario escribe, ¿qué componente es el más adecuado para envolver tu pantalla?", 
