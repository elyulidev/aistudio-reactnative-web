...
export const conference7: CurriculumTopic = {
    ...
    content: [
      ...
      { type: 'paragraph', text: '¡Bienvenidos a una sesión esencial para el desarrollo de interfaces de usuario en React Native! Hoy nos enfocaremos en la gestión de assets, cubriendo cómo trabajar con imágenes, configurar fuentes tipográficas personalizadas e integrar librerías de íconos. Una buena gestión de estos recursos no solo mejora la estética de nuestra aplicación, sino también su rendimiento y mantenibilidad.' },
      { type: 'divider' },
      
      { type: 'subtitle', text: '1. Uso Eficiente de Imágenes Locales Mediante require()' },
      { type: 'paragraph', text: 'Las imágenes son un componente fundamental en casi cualquier aplicación. En React Native, tenemos varias formas de mostrarlas, pero es crucial entender la diferencia entre imágenes locales y remotas, y cuándo usar cada una.' },
      { type: 'list', items: [
      ...
      { type: 'code', language: 'jsx', code: `import { Image, View, StyleSheet } from 'react-native';\n\nconst Logo = () => (\n  <Image \n    source={require('../assets/images/logo.png')} \n    style={{ width: 100, height: 100 }}\n  />\n);` },
      ...
      { type: 'paragraph', text: '**Configuración de `images.d.ts` para TypeScript:**' },
      { type: 'paragraph', text: 'Si utilizas TypeScript, es común que el IDE se queje de la falta de declaraciones de tipo para los archivos de imagen. Para solucionar esto, crea un archivo `images.d.ts` en la raíz de tu proyecto y declara los módulos:' },
      { type: 'code', language: 'typescript', code: `// images.d.ts\ndeclare module '*.png';\ndeclare module '*.jpg';\ndeclare module '*.jpeg';` },

      { type: 'paragraph', text: '**Organización de Assets:**' },
      { type: 'paragraph', text: 'Es una buena práctica organizar tus imágenes en una carpeta `assets/images`. También puedes centralizar la importación y exportación de imágenes desde un solo archivo (ej. `constants/images.ts`) para facilitar su uso en toda la aplicación.' },
      
      { type: 'divider' },

      { type: 'subtitle', text: '2. Configuración y Aplicación de Fuentes Personalizadas' },
      { type: 'paragraph', text: 'Usar fuentes personalizadas es clave para la identidad visual de una aplicación. Expo facilita enormemente este proceso con el paquete `expo-font`.' },
      { type: 'list', items: [
      ...
      { type: 'code', language: 'jsx', code: `// app/_layout.tsx
...
module.exports = {
  ...
  // ...
      ...
      { type: 'paragraph', text: 'Los íconos son elementos esenciales para la navegación y la comunicación visual. `expo/vector-icons` es una colección muy completa que facilita la inclusión de miles de íconos.' },
      { type: 'list', items: [
      ...
      { type: 'code', language: 'jsx', code: `import { Ionicons } from '@expo/vector-icons';\n\nconst HomeIcon = () => (\n  <Ionicons name="home-outline" size={24} color="black" />\n);`},
      { type: 'list', items: [
      ...
      { type: 'paragraph', text: 'Para consolidar lo aprendido, vamos a mejorar la barra de navegación inferior (Tab Bar) de nuestra aplicación, usando íconos de Expo Vector Icons y aplicando una fuente personalizada.' },
      { type: 'list', items: [
      ...
      { type: 'code', language: 'jsx', code: `// app/(tabs)/_layout.tsx (Ejemplo para la pestaña 'Home')
...
/>`},
    { type: 'paragraph', text: '**Resultado Esperado:** Al ejecutar la aplicación, deberías ver los íconos personalizados en la barra de navegación inferior, que cambian de estilo cuando están activos, y el texto debería usar la fuente personalizada que has configurado.' },
    { type: 'divider' },
    { type: 'heading', text: '¡Pon a prueba tus conocimientos!' },
    {
      ...
      questions: [
        {
          "question": "¿Cuál es la forma correcta de incluir una imagen local en un componente de React Native?",
          "options": [
        ...
        {
          "question": "¿Qué hook de `expo-font` se recomienda para cargar fuentes personalizadas en tu aplicación?",
          "options": [
            "loadAsync",
            "useFonts",
            "useEffect",
        ...
        {
          "question": "Para usar íconos del conjunto Ionicons en tu componente, ¿cuál es la declaración de importación correcta?",
          "options": [
        ...
        {
          "question": "Si usas TypeScript e importas un archivo PNG, ¿qué debes hacer para evitar errores de tipo?",
          "options": [
