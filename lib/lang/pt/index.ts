    ...
    },
    {
        ...
        overview: {
            ...
            content: [
                ...
                { type: 'paragraph', text: 'Neste módulo, você aprenderá a armazenar e gerenciar dados directamente no dispositivo do usuário, utilizando o Expo SQLite e o Drizzle ORM como uma solução local.' },
            ]
        },
        conferences: [
            conference17,
...
const evaluations: CurriculumTopic = {
    ...
    content: [
        ...
        { type: 'paragraph', text: 'Aqui você pode encontrar os relatórios de avaliação do curso. Por favor, baixe a versão correspondente ao seu idioma.' },
        {
            ...
            evaluationCards: [
                {
                    ...
                    description: 'Este documento contiene el informe detallado de las evaluaciones parcial y final del curso en español.',
                ...
                },
                {
                    ...
                    description: 'Este documento contém o relatório detalhado das avaliações parcial e final do curso em português.',
...
const bibliography: CurriculumTopic = {
    ...
    content: [
        ...
        { type: 'paragraph', text: 'Aqui encontrará uma coleção de livros e documentação oficial recomendada para aprofundar os temas do bootcamp.' },
        {
            ...
            bibliographyCards: [
                {
                    ...
                    description: 'Um livro completo que abrange os fundamentos e padrões avançados para construir aplicações de alta qualidade com React Native.',
                    buttonText: 'Baixar PDF',
                    url: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf'
                },
                {
                    ...
                    description: 'Aprenda a projetar e gerir bases de dados relacionais locais, um recurso essencial para a persistência de dados offline.',
                    buttonText: 'Baixar PDF',
                    url: 'https://www.adobe.com/support/products/enterprise/knowledgecenter/media/c4611_sample_explain.pdf'
                },
                {
                    ...
                    description: 'A fonte da verdade para tudo relacionado ao React Native. Indispensável para consultar APIs de componentes e guias.',
                ...
                },
                {
                    ...
                    description: 'Explore o ecossistema Expo, desde o roteamento até o acesso a APIs nativas e o processo de build. O seu melhor amigo no desenvolvimento.',
                    buttonText: 'Visitar Site',
