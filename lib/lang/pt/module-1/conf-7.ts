...
export const conference7: CurriculumTopic = {
    ...
    content: [
      { type: 'heading', text: 'Gerenciamento de Ativos: Imagens, Fontes e Ícones' },
      { type: 'paragraph', text: 'Bem-vindos a uma sessão essencial para o desenvolvimento de interfaces de usuário no React Native! Hoje vamos focar no gerenciamento de ativos, cobrindo como trabalhar com imagens, configurar fontes tipográficas personalizadas e integrar bibliotecas de ícones. Um bom gerenciamento desses recursos não só melhora a estética da nossa aplicação, mas também seu desempenho e manutenibilidade.' },
      { type: 'divider' },
      
      { type: 'subtitle', text: '1. Uso Eficiente de Imagens Locais Através do require()' },
      { type: 'paragraph', text: 'As imagens são um componente fundamental em quase qualquer aplicação. No React Native, temos várias formas de exibi-las, mas é crucial entender a diferença entre imagens locais e remotas, e quando usar cada uma.' },
      { type: 'list', items: [
      ...
      { type: 'paragraph', text: '**Configuração de `images.d.ts` para TypeScript:**' },
      { type: 'paragraph', text: 'Se você utiliza TypeScript, é comum que o IDE reclame da falta de declarações de tipo para os arquivos de imagem. Para solucionar isso, crie um arquivo `images.d.ts` na raiz do seu projeto e declare os módulos:' },
      { type: 'code', language: 'typescript', code: `// images.d.ts\ndeclare module '*.png';\ndeclare module '*.jpg';\ndeclare module '*.jpeg';` },

      { type: 'paragraph', text: '**Organização de Ativos:**' },
      { type: 'paragraph', text: 'É uma boa prática organizar suas imagens numa pasta `assets/images`. Você também pode centralizar a importação e exportação de imagens de um único arquivo (ex. `constants/images.ts`) para facilitar seu uso em toda a aplicação.' },
      
      { type: 'divider' },

      { type: 'subtitle', text: '2. Configuração e Aplicação de Fontes Personalizadas' },
      { type: 'paragraph', text: 'Usar fontes personalizadas é fundamental para a identidade visual de uma aplicação. O Expo facilita enormemente este processo com o pacote `expo-font`.' },
      { type: 'list', items: [
...
module.exports = {
  ...
  // ...
      ...
      { type: 'paragraph', text: 'Os ícones são elementos essenciais para a navegação e a comunicação visual. A `expo/vector-icons` é uma coleção muito completa que facilita a inclusão de milhares de ícones.' },
      { type: 'list', items: [
      ...
      { type: 'paragraph', text: 'Para consolidar o que foi aprendido, vamos mejorar a barra de navegação inferior (Tab Bar) da nossa aplicação, usando ícones do Expo Vector Icons e aplicando uma fonte personalizada.' },
      { type: 'list', items: [
      ...
      { type: 'code', language: 'jsx', code: `// app/(tabs)/_layout.tsx (Exemplo para a aba 'Home')
...
/>`},
    { type: 'paragraph', text: '**Resultado Esperado:** Ao executar a aplicação, você deverá ver os ícones personalizados na barra de navegação inferior, que mudam de estilo quando estão ativos, e o texto deverá usar a fonte personalizada que você configurou.' },
    { type: 'divider' },
    { type: 'heading', text: 'Teste os seus conhecimentos!' },
    {
      ...
      questions: [
        {
          "question": "Qual é a forma correta de incluir uma imagem local num componente React Native?",
          "options": [
        ...
        {
          "question": "Que hook do `expo-font` é recomendado para carregar fontes personalizadas na sua aplicação?",
          "options": [
            "loadAsync",
            "useFonts",
            "useEffect",
        ...
        {
          "question": "Para usar ícones do conjunto Ionicons no seu componente, qual é a declaração de importação correta?",
          "options": [
        ...
        {
          "question": "Se utilizar TypeScript e importar um ficheiro PNG, o que deve fazer para evitar erros de tipo?",
          "options": [
