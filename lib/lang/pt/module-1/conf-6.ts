...
export const conference6: CurriculumTopic = {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'De seguida, crie um ficheiro chamado `global.css` na raiz do seu projeto e adicione as diretivas do Tailwind.' },
      ...
      { type: 'callout', alertType: 'warning', text: 'Importante! Após a configuração, reinicie completamente o servidor de desenvolvimento (\`npx expo start --clear\`) para garantir que todas as alterações sejam aplicadas corretamente.' },
      
      { type: 'divider' },

      { type: 'subtitle', text: '2. Uso de Classes do Tailwind CSS' },
      { type: 'paragraph', text: 'Com o NativeWind configurado, podemos aplicar estilos aos nossos componentes React Native utilizando a prop `className`, de forma muito semelhante ao que faríamos na web. Isto permite um desenvolvimento rápido e uma interface de utilizador consistente.' },
      ...
      { type: 'paragraph', text: 'A maioria dos IDEs (como o VSCode com a extensão do Tailwind CSS) oferece autocompletar e sugestões inteligentes para as classes do Tailwind. Além disso, pode estender o tema no `tailwind.config.js` para definir a sua própria paleta de cores, tipografias e mais.' },
      { type: 'code', language: 'javascript', code: `// tailwind.config.js\nmodule.exports = {\n  // ...\n  theme: {\n    extend: {\n      colors: {\n        primary: '#FF6363',\n        'dark-200': '#2A2A2A',\n      },\n      fontFamily: {\n        'quicksand-bold': ['Quicksand-Bold', 'sans-serif'],\n      }\n    },\n  },\n  // ...\n};`},
      { type: 'paragraph', text: 'Uma vez definidos, pode usá-los como `text-primary`, `bg-dark-200` ou `font-quicksand-bold`.' },

      { type: 'divider' },
      
      { type: 'subtitle', text: '4. Gestão de `globals.css`' },
      { type: 'paragraph', text: 'Embora o Tailwind seja "utility-first", por vezes quererá criar as suas próprias classes compostas ou "componentes" que encapsulam várias utilidades. Pode defini-las no `global.css` para uma reutilização fácil.' },
      { type: 'code', language: 'css', code: `@tailwind base;\n@tailwind components;\n@tailwind utilities;\n\n@layer components {\n  .h1-bold {\n    @apply text-3xl font-bold text-gray-900;\n  }\n}` },
      { type: 'paragraph', text: 'Depois, pode usar `className="h1-bold"` no seu JSX, mantendo o código mais limpo.' },

      { type: 'divider' },
      
      { type: 'subtitle', text: '5. Tarefa Prática: Refatoração para NativeWind' },
      { 
        type: 'assignment',
