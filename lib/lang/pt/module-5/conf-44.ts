...
export const conference44: CurriculumTopic = {
    ...
    content: [
        ...
        { type: 'subtitle', text: '2. Prática: Criando um Componente `<Button>` Reutilizável' },
        { type: 'paragraph', text: 'Vamos construir um componente de botão que possa ter diferentes variantes (primário, secundário) e tamanhos, e que seja completamente reutilizável na nossa aplicação.' },
...
`},
        { type: 'paragraph', text: 'Agora, em qualquer parte da sua app, pode usá-lo assim:' },
...
`},
        ...
        { type: 'subtitle', text: '3. Padrão de Composição: Criando um `<Card>` Genérico' },
        { type: 'paragraph', text: 'Um componente de cartão é um contentor comum. Em vez de forçar uma estrutura de título/conteúdo, vamos torná-lo flexível usando `children`.' },
...
export default Card;
`},
        { type: 'paragraph', text: 'Este `Card` agora pode conter qualquer coisa, dando-lhe uma flexibilidade incrível:' },
        { type: 'code', language: 'jsx', code: `
// Uso simples
<Card>
...
`},
        { type: 'callout', alertType: 'info', text: 'Este padrão, onde um componente é usado para "envolver" outros, é conhecido como composição e é um dos conceitos mais fundamentais e poderosos do React.' },
    ]
};
