...
`},
        { type: 'callout', alertType: 'warning', text: 'Após adicionar o plugin do Babel, é crucial reiniciar o servidor de desenvolvimento com `npx expo start --clear`.' },
        ...
        { type: 'subtitle', text: '4. Prática: Animando o Aparecimento de um Componente' },
        { type: 'paragraph', text: 'Vamos criar um efeito de "fade in" e deslizamento para cima para um componente quando ele aparece.' },
...
`},
        { type: 'callout', alertType: 'tip', text: 'A chave é usar os componentes `Animated` (ex. `Animated.View`) para que o Reanimated possa aplicar eficientemente os estilos calculados no thread da UI.'}
    ]
};
