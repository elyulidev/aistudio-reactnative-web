...
export const conference42: CurriculumTopic = {
    ...
    content: [
        ...
        { type: 'paragraph', text: 'Continuamos com a nossa aplicação de imobiliária. Nesta parte, construiremos o componente reutilizável `PropertyCard`, o ecrã de detalhes da propriedade, e o formulário para adicionar novas propriedades, incluindo a seleção de imagens do dispositivo.' },
        { type: 'divider' },

        { type: 'subtitle', text: 'Passo 5: Criar o Componente `PropertyCard`' },
        { type: 'paragraph', text: 'Crie um ficheiro `components/PropertyCard.tsx`. Este componente mostrará um resumo de uma propriedade e será o elemento renderizado na nossa `FlatList`.' },
...
`},
        { type: 'paragraph', text: 'Não se esqueça de importar e usar este componente no `renderItem` da `FlatList` em `app/index.tsx`.' },
        { type: 'divider' },

        { type: 'subtitle', text: 'Passo 6: Criar o Ecrã de Detalhes (`app/property/[id].tsx`)' },
        { type: 'paragraph', text: 'Este ecrã mostrará toda a informação de uma propriedade específica.' },
        { type: 'code', language: 'tsx', code: `
// app/property/[id].tsx
...
`},
        ...
        { type: 'subtitle', text: 'Passo 7: Criar o Formulário de Adicionar/Editar Propriedade' },
        { type: 'paragraph', text: 'Crie o ecrã `app/add-property.tsx`. Este formulário servirá tanto para criar novas propriedades como para editar as existentes.' },
        { type: 'paragraph', text: 'Instale as dependências necessárias para a seleção de imagens:' },
...
`},
        { type: 'paragraph', text: 'Parabéns! Você completou uma aplicação full-stack local, gerindo dados, imagens e navegação complexa.' }
    ]
};
