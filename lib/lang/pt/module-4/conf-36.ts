...
export const conference36: CurriculumTopic = {
    ...
    content: [
      ...
      { type: 'paragraph', text: '**2. Esquema da Base de Dados para Favoritos:**' },
      { type: 'list', items: [
      ...
      { type: 'paragraph', text: '**5. Tela de Detalhes (`app/recipe/[id].tsx`):**' },
      { type: 'list', items: [
      ...
      { type: 'callout', alertType: 'tip', text: 'Este workshop é uma excelente oportunidade para rever e conectar todos os conceitos do módulo. Leve o seu tempo para entender como cada peça (API, estado, UI, base de dados) interage com as outras. Não hesite em usar o Drizzle Studio para verificar se os seus favoritos são guardados corretamente!' }
    ]
};
